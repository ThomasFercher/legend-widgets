...
class DynamicRow extends MultiChildRenderObjectWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DoubleProperty('vSpacing', vSpacing));
    properties.add(DoubleProperty('hSpacing', hSpacing));
...
extension on RenderBox {
  CustomLayoutParentData get pData => this.parentData as CustomLayoutParentData;
}
